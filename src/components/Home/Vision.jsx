...
export default function Vision() {
  return (
    <section className="bg-[#1A1A1A] pt-[133px] pb-[241px] -1024:py-[110px] gap-[74px] -1024:gap-[35px] flex -1024:flex-col -1024:items-center justify-center items-end text-white px-[20px]">
      {/* Enzo */}
      <div className="flex flex-col gap-[72px] -1024:gap-[35px]">
        <h2 className="sub-heading max-w-[671px] -1024:max-w-[800px] text-anim">
      ...
      {/* Vision */}
      <div className="max-w-[471px] flex flex-col gap-[24px] -1024:gap-[15px]">
